...
@section('content')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Data Admin Gudang</li>
        </ol>
        <br />
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">Data Admin Gudang</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-success btn-edit-gudang"><i class="fa fa-edit">
                                                    Ubah</i></button> &nbsp;
                                            <a href="{{ route('delete.gudang', @$value->id) }}"><button
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Tambah Data Admin Gudang</h4>
                </div>
    ...
    <div class="modal fade" id="modal-form-edit-gudang" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Form Update Data Gudang</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('update.gudang') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
